...
from .baseline import Baseline, FeatureExtraction
...
def build_fe_model(cfg, num_classes):
    model = FeatureExtraction(num_classes, cfg.MODEL.LAST_STRIDE, cfg.MODEL.PRETRAIN_PATH, cfg.MODEL.NECK, cfg.TEST.NECK_FEAT, cfg.MODEL.NAME, cfg.MODEL.PRETRAIN_CHOICE)
    return model
